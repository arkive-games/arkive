...
function FormulaCard({
  ...
  return (
    <div
      className={cn(
        'relative grid grid-cols-[1fr_auto_1fr_auto_1fr] items-center gap-1.5 rounded-lg border px-3 py-2 text-sm',
        f.unique
    ...
    >
      {f.unique ? (
        <span
          className="absolute -top-2 right-2 inline-flex items-center gap-1 rounded-full border border-amber-400/70 bg-amber-100 px-1.5 py-0.5 text-[10px] font-medium text-amber-700 dark:bg-amber-950 dark:text-amber-300"
          title={uniqueLabel}
        >
...
export default function BreedingPage() {
  ...
  const shown = result.list.slice(0, RENDER_CAP)

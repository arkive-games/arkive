...
from ...models.body_marker_feedback_update_marker_feedback_api_v1_maps_map_marker_feedbacks_feedback_patch import (
...
def _get_kwargs(
    ...
    feedback: UUID,
    *,
    body: BodyMarkerFeedbackUpdateMarkerFeedbackApiV1MapsMapMarkerFeedbacksFeedbackPatch,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Markerfeedback.Update Marker Feedback

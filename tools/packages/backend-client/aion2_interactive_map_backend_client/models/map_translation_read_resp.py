...
T = TypeVar("T", bound="MapTranslationReadResp")


@_attrs_define
class MapTranslationReadResp:
    """
    Attributes:
        error_code (ErrorCode):
        error_message (str | Unset):  Default: ''.
        show_type (ErrorShowType | Unset):
        data (MapTranslationRead | None | Unset):
    """

    error_code: ErrorCode
    error_message: str | Unset = ""
    show_type: ErrorShowType | Unset = UNSET
    data: MapTranslationRead | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.data, Unset):
            data = UNSET
        elif isinstance(self.data, MapTranslationRead):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> MapTranslationRead | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_type_0 = MapTranslationRead.from_dict(data)

                return data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(MapTranslationRead | None | Unset, data)

        data = _parse_data(d.pop("data", UNSET))

        map_translation_read_resp = cls(
        ...
        map_translation_read_resp.additional_properties = d
        return map_translation_read_resp

...
T = TypeVar("T", bound="MarkerTranslationReadResp")


@_attrs_define
class MarkerTranslationReadResp:
    """
    Attributes:
        error_code (ErrorCode):
        error_message (str | Unset):  Default: ''.
        show_type (ErrorShowType | Unset):
        data (MarkerTranslationRead | None | Unset):
    """

    error_code: ErrorCode
    error_message: str | Unset = ""
    show_type: ErrorShowType | Unset = UNSET
    data: MarkerTranslationRead | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.data, Unset):
            data = UNSET
        elif isinstance(self.data, MarkerTranslationRead):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> MarkerTranslationRead | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_type_0 = MarkerTranslationRead.from_dict(data)

                return data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(MarkerTranslationRead | None | Unset, data)

        data = _parse_data(d.pop("data", UNSET))

        marker_translation_read_resp = cls(
        ...
        marker_translation_read_resp.additional_properties = d
        return marker_translation_read_resp

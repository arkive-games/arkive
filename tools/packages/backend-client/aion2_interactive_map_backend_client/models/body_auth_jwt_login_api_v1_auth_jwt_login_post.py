...
T = TypeVar("T", bound="BodyAuthJwtLoginApiV1AuthJwtLoginPost")


@_attrs_define
class BodyAuthJwtLoginApiV1AuthJwtLoginPost:
    """
    Attributes:
        username (str):
        password (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_auth_jwt_login_api_v1_auth_jwt_login_post = cls(
            username=username,
            password=password,
        ...
        body_auth_jwt_login_api_v1_auth_jwt_login_post.additional_properties = d
        return body_auth_jwt_login_api_v1_auth_jwt_login_post

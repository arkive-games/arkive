...
class EmptyResp:
    ...
    Attributes:
        ...
        data (Empty | None | Unset):
    """

    error_code: ErrorCode
    error_message: str | Unset = ""
    show_type: ErrorShowType | Unset = UNSET
    data: Empty | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.data, Unset):
            data = UNSET
        elif isinstance(self.data, Empty):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Empty | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_type_0 = Empty.from_dict(data)

                return data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(Empty | None | Unset, data)
        ...
        empty_resp.additional_properties = d
        return empty_resp

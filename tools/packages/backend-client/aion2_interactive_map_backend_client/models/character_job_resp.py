...
if TYPE_CHECKING:
    from ..models.character_job import CharacterJob


T = TypeVar("T", bound="CharacterJobResp")


@_attrs_define
class CharacterJobResp:
    """
    Attributes:
        error_code (ErrorCode):
        error_message (str | Unset):  Default: ''.
        show_type (ErrorShowType | Unset):
        data (CharacterJob | None | Unset):
    """

    error_code: ErrorCode
    error_message: str | Unset = ""
    show_type: ErrorShowType | Unset = UNSET
    data: CharacterJob | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.data, Unset):
            data = UNSET
        elif isinstance(self.data, CharacterJob):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> CharacterJob | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_type_0 = CharacterJob.from_dict(data)

                return data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CharacterJob | None | Unset, data)

        data = _parse_data(d.pop("data", UNSET))

        character_job_resp = cls(
        ...
        character_job_resp.additional_properties = d
        return character_job_resp

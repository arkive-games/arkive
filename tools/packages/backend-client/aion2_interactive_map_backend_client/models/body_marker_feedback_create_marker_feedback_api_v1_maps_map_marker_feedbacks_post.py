...
T = TypeVar("T", bound="BodyMarkerFeedbackCreateMarkerFeedbackApiV1MapsMapMarkerFeedbacksPost")



@_attrs_define
class BodyMarkerFeedbackCreateMarkerFeedbackApiV1MapsMapMarkerFeedbacksPost:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_marker_feedback_create_marker_feedback_api_v1_maps_map_marker_feedbacks_post = cls(
            file=file,
            type_=type_,
            marker_id=marker_id,
        ...
        body_marker_feedback_create_marker_feedback_api_v1_maps_map_marker_feedbacks_post.additional_properties = d
        return body_marker_feedback_create_marker_feedback_api_v1_maps_map_marker_feedbacks_post

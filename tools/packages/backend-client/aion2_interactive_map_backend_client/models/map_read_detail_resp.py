...
T = TypeVar("T", bound="MapReadDetailResp")


@_attrs_define
class MapReadDetailResp:
    """
    Attributes:
        error_code (ErrorCode):
        error_message (str | Unset):  Default: ''.
        show_type (ErrorShowType | Unset):
        data (MapReadDetail | None | Unset):
    """

    error_code: ErrorCode
    error_message: str | Unset = ""
    show_type: ErrorShowType | Unset = UNSET
    data: MapReadDetail | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.data, Unset):
            data = UNSET
        elif isinstance(self.data, MapReadDetail):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> MapReadDetail | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_type_0 = MapReadDetail.from_dict(data)

                return data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(MapReadDetail | None | Unset, data)

        data = _parse_data(d.pop("data", UNSET))

        map_read_detail_resp = cls(
        ...
        map_read_detail_resp.additional_properties = d
        return map_read_detail_resp

...
T = TypeVar("T", bound="MarkerCommentRead")


@_attrs_define
class MarkerCommentRead:
    """
    Attributes:
        id (UUID):
        content (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        marker_comment_read.additional_properties = d
        return marker_comment_read

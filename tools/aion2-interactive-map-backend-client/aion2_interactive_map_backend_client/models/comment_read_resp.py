...
if TYPE_CHECKING:
    from ..models.comment_read import CommentRead


T = TypeVar("T", bound="CommentReadResp")


@_attrs_define
class CommentReadResp:
    """
    Attributes:
        error_code (ErrorCode):
        error_message (str | Unset):  Default: ''.
        show_type (ErrorShowType | Unset):
        data (CommentRead | None | Unset):
    """

    error_code: ErrorCode
    error_message: str | Unset = ""
    show_type: ErrorShowType | Unset = UNSET
    data: CommentRead | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.data, Unset):
            data = UNSET
        elif isinstance(self.data, CommentRead):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> CommentRead | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_type_0 = CommentRead.from_dict(data)

                return data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CommentRead | None | Unset, data)

        data = _parse_data(d.pop("data", UNSET))

        comment_read_resp = cls(
        ...
        comment_read_resp.additional_properties = d
        return comment_read_resp

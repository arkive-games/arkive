...
T = TypeVar("T", bound="MarkerImageReadDetail")


@_attrs_define
class MarkerImageReadDetail:
    """
    Attributes:
        id (UUID):
        marker_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        marker_image_read_detail.additional_properties = d
        return marker_image_read_detail

...
T = TypeVar("T", bound="BodyAuthCookieLoginApiV1AuthCookieLoginPost")


@_attrs_define
class BodyAuthCookieLoginApiV1AuthCookieLoginPost:
    """
    Attributes:
        username (str):
        password (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_auth_cookie_login_api_v1_auth_cookie_login_post = cls(
            username=username,
            password=password,
        ...
        body_auth_cookie_login_api_v1_auth_cookie_login_post.additional_properties = d
        return body_auth_cookie_login_api_v1_auth_cookie_login_post

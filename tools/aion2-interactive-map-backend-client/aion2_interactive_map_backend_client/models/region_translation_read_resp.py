...
T = TypeVar("T", bound="RegionTranslationReadResp")


@_attrs_define
class RegionTranslationReadResp:
    """
    Attributes:
        error_code (ErrorCode):
        error_message (str | Unset):  Default: ''.
        show_type (ErrorShowType | Unset):
        data (None | RegionTranslationRead | Unset):
    """

    error_code: ErrorCode
    error_message: str | Unset = ""
    show_type: ErrorShowType | Unset = UNSET
    data: None | RegionTranslationRead | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.data, Unset):
            data = UNSET
        elif isinstance(self.data, RegionTranslationRead):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> None | RegionTranslationRead | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_type_0 = RegionTranslationRead.from_dict(data)

                return data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | RegionTranslationRead | Unset, data)

        data = _parse_data(d.pop("data", UNSET))

        region_translation_read_resp = cls(
        ...
        region_translation_read_resp.additional_properties = d
        return region_translation_read_resp

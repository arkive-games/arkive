...
from ...models.abyss_artifact_state_update import AbyssArtifactStateUpdate
...
def _get_kwargs(
    ...
    state: UUID,
    *,
    body: AbyssArtifactStateUpdate,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/api/v1/seasons/{season}/maps/{map_}/artifacts/states/{state}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Abyssartifactstates.Update Abyss Artifact State

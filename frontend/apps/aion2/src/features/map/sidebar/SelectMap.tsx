...
export default function SelectMap() {
  ...
  return (
    <div className="grid grid-cols-[4.75rem_minmax(0,1fr)] items-center gap-2 border-b border-border px-3 py-2.5 max-md:pr-8">
      ...
      <ShellMapSelect
        classNames={{
          trigger:
            "min-h-9 rounded-md border-border bg-card px-2.5 text-sm font-semibold shadow-none hover:border-primary/40 hover:bg-card data-[state=open]:bg-card",

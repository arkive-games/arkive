...
export default function Logo() {
  ...
  return (
    <div
      className="relative flex min-h-20 w-full select-none items-center overflow-hidden bg-cover bg-center px-3 text-white"
      style={{ backgroundImage: `url(${backgroundUrl})` }}
    >
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(6,38,46,0.92),rgba(10,60,70,0.58),rgba(11,34,48,0.20))]" />

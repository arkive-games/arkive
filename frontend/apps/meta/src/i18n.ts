    ...
    translation: {
      ...
      forum: {
        ...
        composer: {
          ...
          toolbar: { label: '正文格式', bold: '加粗', italic: '斜体', underline: '下划线', heading: '二级标题', list: '项目列表', orderedList: '编号列表', quote: '引用', code: '行内代码', link: '插入链接', text: '文字', headingText: '标题', listItem: '列表项目', quoteText: '引用内容', codeText: '代码', linkText: '链接文字' },
    ...
    translation: {
      ...
      forum: {
        ...
        composer: {
          ...
          toolbar: { label: '正文格式', bold: '粗體', italic: '斜體', underline: '底線', heading: '二級標題', list: '項目清單', orderedList: '編號清單', quote: '引用', code: '行內程式碼', link: '插入連結', text: '文字', headingText: '標題', listItem: '清單項目', quoteText: '引用內容', codeText: '程式碼', linkText: '連結文字' },
    ...
    translation: {
      ...
      forum: {
        ...
        composer: {
          ...
          toolbar: { label: 'Post formatting', bold: 'Bold', italic: 'Italic', underline: 'Underline', heading: 'Heading 2', list: 'Bulleted list', orderedList: 'Numbered list', quote: 'Quote', code: 'Inline code', link: 'Insert link', text: 'text', headingText: 'Heading', listItem: 'List item', quoteText: 'Quote', codeText: 'code', linkText: 'link text' },
    ...
    translation: {
      ...
      forum: {
        ...
        composer: {
          ...
          toolbar: { label: '本文の書式', bold: '太字', italic: '斜体', underline: '下線', heading: '見出し2', list: '箇条書き', orderedList: '番号付きリスト', quote: '引用', code: 'インラインコード', link: 'リンクを挿入', text: 'テキスト', headingText: '見出し', listItem: 'リスト項目', quoteText: '引用文', codeText: 'コード', linkText: 'リンク文字' },
    ...
    translation: {
      ...
      forum: {
        ...
        composer: {
          ...
          toolbar: { label: '본문 서식', bold: '굵게', italic: '기울임', underline: '밑줄', heading: '제목 2', list: '글머리 기호', orderedList: '번호 목록', quote: '인용', code: '인라인 코드', link: '링크 삽입', text: '텍스트', headingText: '제목', listItem: '목록 항목', quoteText: '인용문', codeText: '코드', linkText: '링크 텍스트' },

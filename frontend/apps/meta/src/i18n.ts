...
const USER_SYSTEM_COPY = {
  ...
  'zh-TW': {
    notifications: {
      ...
      markAllRead: '全部標為已讀', allRead: '已全部讀完', unread: '未讀', empty: '這裡還沒有訊息。', systemSender: '藏舟社群助手', deletedPost: '已刪除的帖子', accountNumber: 'UID {{id}}', items: { reply: '回覆了你在《{{post}}》中的留言', mention: '在《{{post}}》中提到了你', like: '讚了你的文章《{{post}}》', system: '發布了《{{post}}》' },
  ...
  'en-US': {
    notifications: {
      ...
      inboxDescription: 'Review community activity related to your account.', settingsDescription: 'Choose which messages you want to receive. Changes save immediately.', markAllRead: 'Mark all as read', allRead: 'All caught up', unread: 'Unread', empty: 'Nothing here yet.', systemSender: 'Arkive Community', deletedPost: 'a deleted post', accountNumber: 'UID {{id}}', items: { reply: 'replied to your comment on “{{post}}”', mention: 'mentioned you in “{{post}}”', like: 'liked your post “{{post}}”', system: 'published “{{post}}”' },

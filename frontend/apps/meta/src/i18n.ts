...
const resources = {
  'zh-CN': {
    translation: {
      ...
      home: {
        ...
        searchResults: '搜索结果',
        searchEmpty: '没有找到与“{{query}}”相关的游戏或功能',
        games: '游戏',
        gameCount: '{{count}} 款',
        tools: '工具',
        toolCount: '{{count}} 个',
      ...
      toolsLibrary: {
        eyebrow: '实用工具', title: '工具库', description: '按游戏查找计算、规划与资料整理工具。',
      },
      forum: {
        redesign: FORUM_REDESIGN_COPY['zh-CN'],
        title: '论坛',
        description: '攻略、发现与玩家经验，都在这里汇合。',
        games: { aion2: '永恒之塔2', gmzz: '诡秘之主', palworld: '幻兽帕鲁', vrising: '夜族崛起', sts2: '杀戮尖塔2', ro3: '仙境传说3' },
      ...
      site: {
        ...
        ro3: { name: '仙境传说3', desc: '仙境传说3 技能、副本与职业资料', feature: '查询技能、副本与职业资料。' },
        sts2: {
          name: '杀戮尖塔2',
          desc: '卡牌图鉴、角色资料与构筑知识',
  ...
  'zh-TW': {
    translation: {
      ...
      home: {
        ...
        searchResults: '搜尋結果',
        searchEmpty: '沒有找到與「{{query}}」相關的遊戲或功能',
        games: '遊戲',
        gameCount: '{{count}} 款',
        tools: '工具',
        toolCount: '{{count}} 個',
      ...
      toolsLibrary: {
        eyebrow: '實用工具', title: '工具庫', description: '按遊戲查找計算、規劃與資料整理工具。',
      },
      forum: {
        redesign: FORUM_REDESIGN_COPY['zh-TW'],
        title: '論壇',
        description: '攻略、發現與玩家經驗，都在這裡匯合。',
        games: { aion2: '永恆之塔2', gmzz: '詭秘之主', palworld: '幻獸帕魯', vrising: '夜族崛起', sts2: '殺戮尖塔2', ro3: '仙境傳說3' },
  ...
  'en-US': {
    translation: {
      ...
      hero: { continue: 'Continue exploring' },
      home: {
        ...
        searchEmpty: 'No game or feature matches “{{query}}”',
        games: 'Games',
        ...
        allTools: 'Open the tool library',
      ...
      toolsLibrary: {
        eyebrow: 'Practical tools', title: 'Tool library', description: 'Find calculators, planners, and reference tools by game.',
      },
      forum: {
        redesign: FORUM_REDESIGN_COPY['en-US'],
        title: 'Forum',
        description: 'Guides, discoveries, and player experience meet here.',
        games: { aion2: 'AION2', gmzz: 'Lord of Mysteries', palworld: 'Palworld', vrising: 'V Rising', sts2: 'Slay the Spire 2', ro3: 'Ragnarok Online 3' },
  ...
  'ja-JP': {
    translation: {
      ...
      home: {
        ...
        searchResults: '検索結果',
        searchEmpty: '「{{query}}」に一致するゲームや機能はありません',
        games: 'ゲーム',
        gameCount: '{{count}} 作品',
        tools: 'ツール',
        toolCount: '{{count}} 件',
      ...
      toolsLibrary: {
        eyebrow: '実用ツール', title: 'ツールライブラリ', description: 'ゲーム別の計算、計画、資料整理ツールを探せます。',
      },
      forum: {
  ...
  'ko-KR': {
    translation: {
      ...
      home: {
        ...
        searchResults: '검색 결과',
        searchEmpty: '“{{query}}”와 일치하는 게임이나 기능이 없습니다',
        games: '게임',
        gameCount: '{{count}}개',
        tools: '도구',
        toolCount: '{{count}}개',
      ...
      toolsLibrary: {
        eyebrow: '실용 도구', title: '도구 모음', description: '게임별 계산기, 계획 도구와 참고 자료를 찾습니다.',
      },
      forum: {

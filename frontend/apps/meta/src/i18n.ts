    ...
    translation: {
      ...
      forum: {
        ...
        composer: {
          ...
          removeImage: '删除图片', videoPlaceholder: '粘贴视频链接',
          cancel: '取消', publish: '发布帖子', published: '帖子已发布', openVideo: '查看视频',
          back: '返回论坛', guest: '访客', draftSaved: '草稿已保存', relatedGames: '关联游戏', gameInputPlaceholder: '输入游戏名称', matchingGames: '匹配游戏', pressEnter: '回车选择', noMatchingGames: '没有匹配的游戏', removeGame: '移除游戏 {{game}}',
    ...
    translation: {
      ...
      forum: {
        ...
        composer: {
          ...
          removeImage: '刪除圖片', videoPlaceholder: '貼上影片連結',
          cancel: '取消', publish: '發佈文章', published: '文章已發佈', openVideo: '查看影片',
          back: '返回論壇', guest: '訪客', draftSaved: '草稿已儲存', relatedGames: '關聯遊戲', gameInputPlaceholder: '輸入遊戲名稱', matchingGames: '符合的遊戲', pressEnter: 'Enter 選擇', noMatchingGames: '沒有符合的遊戲', removeGame: '移除遊戲 {{game}}',
    ...
    translation: {
      ...
      forum: {
        ...
        composer: {
          ...
          removeImage: 'Remove image', videoPlaceholder: 'Paste a video link',
          cancel: 'Cancel', publish: 'Publish post', published: 'Post published', openVideo: 'View video',
          back: 'Back to forum', guest: 'Guest', draftSaved: 'Draft saved', relatedGames: 'Related games', gameInputPlaceholder: 'Type a game name', matchingGames: 'Matching games', pressEnter: 'Press Enter', noMatchingGames: 'No matching games', removeGame: 'Remove {{game}}',
    ...
    translation: {
      ...
      forum: {
        ...
        composer: {
          ...
          removeImage: '画像を削除', videoPlaceholder: '動画リンクを貼り付け',
          cancel: 'キャンセル', publish: '投稿する', published: '投稿しました', openVideo: '動画を見る',
          back: 'フォーラムへ戻る', guest: 'ゲスト', draftSaved: '下書きを保存しました', relatedGames: '関連ゲーム', gameInputPlaceholder: 'ゲーム名を入力', matchingGames: '一致するゲーム', pressEnter: 'Enterで選択', noMatchingGames: '一致するゲームがありません', removeGame: '{{game}}を削除',
    ...
    translation: {
      ...
      forum: {
        ...
        composer: {
          ...
          removeImage: '이미지 삭제', videoPlaceholder: '동영상 링크 붙여넣기',
          cancel: '취소', publish: '게시글 등록', published: '게시글이 등록되었습니다', openVideo: '동영상 보기',
          back: '포럼으로 돌아가기', guest: '게스트', draftSaved: '초안 저장됨', relatedGames: '관련 게임', gameInputPlaceholder: '게임 이름 입력', matchingGames: '일치하는 게임', pressEnter: 'Enter로 선택', noMatchingGames: '일치하는 게임 없음', removeGame: '{{game}} 삭제',

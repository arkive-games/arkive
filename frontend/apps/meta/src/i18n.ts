    ...
    translation: {
      ...
      forum: {
        ...
        composer: {
          ...
          back: '返回论坛', draftSaved: '草稿已保存', relatedGames: '关联游戏', gameInputPlaceholder: '输入游戏名称', matchingGames: '匹配游戏', pressEnter: '回车选择', noMatchingGames: '没有匹配的游戏', removeGame: '移除游戏 {{game}}',
    ...
    translation: {
      ...
      forum: {
        ...
        composer: {
          ...
          back: '返回論壇', draftSaved: '草稿已儲存', relatedGames: '關聯遊戲', gameInputPlaceholder: '輸入遊戲名稱', matchingGames: '符合的遊戲', pressEnter: 'Enter 選擇', noMatchingGames: '沒有符合的遊戲', removeGame: '移除遊戲 {{game}}',
    ...
    translation: {
      ...
      forum: {
        ...
        composer: {
          ...
          back: 'Back to forum', draftSaved: 'Draft saved', relatedGames: 'Related games', gameInputPlaceholder: 'Type a game name', matchingGames: 'Matching games', pressEnter: 'Press Enter', noMatchingGames: 'No matching games', removeGame: 'Remove {{game}}',
    ...
    translation: {
      ...
      forum: {
        ...
        composer: {
          ...
          back: 'フォーラムへ戻る', draftSaved: '下書きを保存しました', relatedGames: '関連ゲーム', gameInputPlaceholder: 'ゲーム名を入力', matchingGames: '一致するゲーム', pressEnter: 'Enterで選択', noMatchingGames: '一致するゲームがありません', removeGame: '{{game}}を削除',
    ...
    translation: {
      ...
      forum: {
        ...
        composer: {
          ...
          back: '포럼으로 돌아가기', draftSaved: '초안 저장됨', relatedGames: '관련 게임', gameInputPlaceholder: '게임 이름 입력', matchingGames: '일치하는 게임', pressEnter: 'Enter로 선택', noMatchingGames: '일치하는 게임 없음', removeGame: '{{game}} 삭제',

...
import { MARKER_DETAIL_STRINGS } from './markerDetailStrings'
import {
  LOOT_TIER_LABELS,
...
const resources = {
  ...
  'fr-FR': {
    translation: {
      ...
      showRegions: 'Afficher les régions',
  ...
  i18n.addResourceBundle(
    ...
    'translation',
    {
      ...
      build: {
        ...
        time: BUILD_TIME_LABELS[lng],
        game: BUILD_GAME_LABELS[lng],
      },
      ...
      markerDetail: MARKER_DETAIL_STRINGS[lng],
      mapControls: {

// V Rising's wiring for the shared map-engine switcher.
//
...
// app-specific: the storage key inside the app's existing `vrising.map.*`
...
// as the adapters in `lib/storage.ts`).

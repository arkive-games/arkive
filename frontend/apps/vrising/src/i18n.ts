...
const en = {
  ...
  siteInfo: {
    ...
    body: [
      'Explore Vardoran with searchable markers, regions, patrol routes, and both map renderers.',
      'Map data is extracted from the game and refined for reference use.',
    ],
    arkive: 'This interactive map is part of the Arkive game-guide collection.',
...
const zhCN: Strings = {
  ...
  siteInfo: {
    ...
    title: '关于本地图',
    body: [
      '在瓦尔多兰查询地点、区域、巡逻路线与各类地图标记。',
      '地图数据来自游戏资源提取，并持续整理为便于查阅的攻略资料。',
    ],
    arkive: '本互动地图是藏舟游戏攻略体系的一部分。',
    version: '版本记录',
...
const zhTW: Strings = {
  ...
  siteInfo: {
    ...
    title: '關於本地圖',
    body: [
      '在瓦爾多蘭查詢地點、區域、巡邏路線與各類地圖標記。',
      '地圖資料來自遊戲資源提取，並持續整理為便於查閱的攻略資料。',
    ],
    arkive: '本互動地圖是藏舟遊戲攻略體系的一部分。',
    version: '版本記錄',
    changelog: '查看版本 {{version}}',
    copy: '複製',
    copied: '已複製',

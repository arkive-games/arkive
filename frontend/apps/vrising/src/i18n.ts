...
const en = {
  ...
  siteInfo: {
    ...
    introBefore: 'This unofficial V Rising interactive map and database is built and maintained by ',
    arkiveName: 'Arkive',
    introAfter: '. Game data is extracted from the game files, and the site will always remain free to use.',
    disclaimer: 'This site is not affiliated with, authorized, or endorsed by Stunlock Studios. All rights to V Rising and its related game content belong to Stunlock Studios.',
    version: 'Version history',
    changelog: 'View version {{version}}',
    copy: 'Copy',
    copied: 'Copied',
    contact: { title: '', hint: '', groupLabel: '' },
  },
...
const zhCN: Strings = {
  ...
  siteInfo: {
    ...
    introBefore: '本站是由',
    arkiveName: '藏舟攻略网',
    introAfter: '搭建与维护的夜族崛起非官方互动地图与资料库，游戏数据均从游戏文件中提取，永久免费开放。',
    disclaimer: '本站与 Stunlock Studios 无隶属关系，也未获其授权或背书。夜族崛起及相关游戏内容的一切权利均归 Stunlock Studios 所有。',
    version: '版本记录',
    changelog: '查看版本 {{version}}',
    copy: '复制',
    copied: '已复制',
    contact: {
      title: '反馈与纠错',
      hint: '发现数据问题或希望补充内容，欢迎加入反馈群。',
      groupLabel: 'QQ 群',
    },
  },
...
const zhTW: Strings = {
  ...
  siteInfo: {
    ...
    introBefore: '本站是由',
    arkiveName: '藏舟攻略網',
    introAfter: '搭建與維護的夜族崛起非官方互動地圖與資料庫，遊戲資料均從遊戲檔案中提取，永久免費開放。',
    disclaimer: '本站與 Stunlock Studios 無隸屬關係，也未獲其授權或背書。夜族崛起及相關遊戲內容的一切權利均歸 Stunlock Studios 所有。',
    version: '版本記錄',
    changelog: '查看版本 {{version}}',
    copy: '複製',
    copied: '已複製',

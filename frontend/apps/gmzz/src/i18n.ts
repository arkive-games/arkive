...
const en = {
  ...
  equip: {
    ...
    "subtotalBonus": "Extraordinary bonus {{value}}",
    "item": "Item",
    ...
    "slotAndLevel": "{{slot}} · gear level {{level}}",
    "typeAndLevel": "{{type}} · gear level {{level}}",
    "pieceScore": "Score {{score}}",
    "scoreParts": "Base {{base}} · Enhancement {{enhance}} · Reforge {{reforge}}",
    "stats": "Stats",
    ...
    "stageOption": "+{{stage}}",
    "percentValue": "{{value}}%",
    "enhanceDerived": "{{score}} score · {{stages}} stages",
    "brand": "Brand",
    ...
    "reforgeParts": "affixes {{mark}} + bonus {{bonus}} for {{count}} extraordinary",
...
const zhCN: Strings = {
  ...
  equip: {
    ...
    "itemPlaceholder": "未选择",
    "emptySlot": "空栏位",
    "slotAndLevel": "{{slot}} · {{level}}装等",
    "typeAndLevel": "{{type}} · {{level}}装等",
    "pieceScore": "评分 {{score}}",
    "scoreParts": "基础 {{base}} · 强化 {{enhance}} · 重塑 {{reforge}}",
    "stats": "基础属性",
    "noStats": "选择装备后显示属性",
    "enhance": "强化",
    "enhanceStage": "强化等级",
    ...
    "stageOption": "+{{stage}}",
    "percentValue": "{{value}}%",
    "enhanceDerived": "{{score}} 评分（共 {{stages}} 阶）",
    "brand": "烙印",
    "affixes": "重塑词条",
    "affixFamily": "词条属性",
    "affixValue": "词条数值",
    ...
    "reforgeParts": "词条 {{mark}} + 非凡加成 {{bonus}}（{{count}} 非凡）",
    "noGrace": "该组合没有对应恩赐"
  },
  relic: {
    "title": "封印物",
...
const zhTW: Strings = {
  ...
  equip: {
    ...
    "itemPlaceholder": "未選擇",
    "emptySlot": "空欄位",
    "slotAndLevel": "{{slot}} · {{level}}裝等",
    "typeAndLevel": "{{type}} · {{level}}裝等",
    "pieceScore": "評分 {{score}}",
    "scoreParts": "基礎 {{base}} · 強化 {{enhance}} · 重塑 {{reforge}}",
    "stats": "基礎屬性",
    "noStats": "選擇裝備後顯示屬性",
    "enhance": "強化",
    "enhanceStage": "強化等級",
    ...
    "stageOption": "+{{stage}}",
    "percentValue": "{{value}}%",
    "enhanceDerived": "{{score}} 評分（共 {{stages}} 階）",
    "brand": "烙印",
    "affixes": "重塑詞條",
    "affixFamily": "詞條屬性",
    "affixValue": "詞條數值",
    ...
    "tierSpecial": "特殊",
    "reforgeScore": "重塑 {{score}}",
    "reforgeParts": "詞條 {{mark}} + 非凡加成 {{bonus}}（{{count}} 非凡）",
    "noGrace": "該組合沒有對應恩賜"
  },
  relic: {
    "title": "封印物",

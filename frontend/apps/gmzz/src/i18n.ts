...
const en = {
  ...
  nav: {"home": "Home", "traintrade": "Train Trade", "utopia": "Utopian Theater", "reforge": "Reforge Graces", "changelog": "Changelog"},
  siteInfo: {
    tab: 'About',
...
const zhCN: Strings = {
  ...
  themeMenu: '主题',
  languageMenu: '语言',
  nav: {"home": "首页", "traintrade": "铁路大亨", "utopia": "乌托邦剧场", "reforge": "重塑恩赐", "changelog": "更新日志"},
  siteInfo: {
    tab: '关于',
    aboutTitle: '关于本站',
    arkiveName: '藏舟攻略网',
...
const zhTW: Strings = {
  ...
  themeMenu: '主題',
  languageMenu: '語言',
  nav: {"home": "首頁", "traintrade": "鐵路大亨", "utopia": "烏托邦劇場", "reforge": "重塑恩賜", "changelog": "更新日誌"},
  siteInfo: {
    tab: '關於',
    aboutTitle: '關於本站',
    arkiveName: '藏舟攻略網',

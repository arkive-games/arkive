...
const en = {
  ...
  equip: {
    ...
    "hint": "Enter what you are wearing to reproduce the rating the game shows. Base score defaults to the item's own value and stays editable.",
    "layout": "Layout",
    "layoutRows": "Rows",
    "layoutCards": "Cards",
    "batchStage": "Enhancement for all",
    "batchPlaceholder": "Apply to all…",
    "batchRefine": "Refinement % for all",
    "suit": "Suit",
    "suitTier": "Tier {{level}} · {{mark}} Mark · average {{percent}}%",
    "suitNoTier": "No suit tier reached yet",
    ...
    "stageOption": "+{{stage}}",
    "enhanceDerived": "{{score}} score · {{percent}}% of {{stages}} stages",
    "brand": "Brand",
...
const zhCN: Strings = {
  ...
  equip: {
    "title": "装备评分",
    "hint": "填入当前穿戴的装备，即可复现游戏内显示的评分。基础评分默认取装备自身数值，仍可手动修改。",
    "layout": "布局",
    "layoutRows": "列表",
    "layoutCards": "卡片",
    "batchStage": "统一强化等级",
    "batchPlaceholder": "应用到全部…",
    "batchRefine": "统一精炼度 %",
    "suit": "套装",
    ...
    "refinePercent": "精炼度 %",
    "stageOption": "+{{stage}}",
    "enhanceDerived": "{{score}} 评分 · {{percent}}%（共 {{stages}} 阶）",
    "brand": "烙印",
    "affixes": "重塑词条",
    "affixTier": "词条品阶",
    "affixFamily": "词条属性",
...
const zhTW: Strings = {
  ...
  equip: {
    "title": "裝備評分",
    "hint": "填入目前穿戴的裝備，即可重現遊戲內顯示的評分。基礎評分預設取裝備自身數值，仍可手動修改。",
    "layout": "佈局",
    "layoutRows": "列表",
    "layoutCards": "卡片",
    "batchStage": "統一強化等級",
    "batchPlaceholder": "套用到全部…",
    "batchRefine": "統一精煉度 %",
    "suit": "套裝",
    ...
    "refinePercent": "精煉度 %",
    "stageOption": "+{{stage}}",
    "enhanceDerived": "{{score}} 評分 · {{percent}}%（共 {{stages}} 階）",
    "brand": "烙印",
    "affixes": "重塑詞條",
    "affixTier": "詞條品階",
    "affixFamily": "詞條屬性",

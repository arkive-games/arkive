...
const en = {
  ...
  equip: {
    ...
    "suitTier": "Tier {{level}} · {{mark}} Mark · average {{percent}}%",
    "suitNoTier": "No suit tier reached yet · average {{percent}}%",
    ...
    "bodyTier": "Whole loadout +{{stage}}: enhancement +{{mark}}",
    "bodyTierNone": "Whole loadout below +3: no enhancement set bonus",
...
const zhCN: Strings = {
  ...
  equip: {
    ...
    "suitTier": "第 {{level}} 阶 · {{mark}} 评分 · 平均 {{percent}}%",
    "suitNoTier": "尚未达到套装阶级 · 平均 {{percent}}%",
    ...
    "bodyTier": "全身+{{stage}}：强化额外 +{{mark}}",
    "bodyTierNone": "全身未满+3，无强化套装加分",
...
const zhTW: Strings = {
  ...
  equip: {
    ...
    "suitTier": "第 {{level}} 階 · {{mark}} 評分 · 平均 {{percent}}%",
    "suitNoTier": "尚未達到套裝階級 · 平均 {{percent}}%",
    "kindAdventure": "副本（PVE）",
    "kindArena": "競技（PVP）",
    "totalScore": "總評分",
    ...
    "bodyTier": "全身+{{stage}}：強化額外 +{{mark}}",
    "bodyTierNone": "全身未滿+3，無強化套裝加分",

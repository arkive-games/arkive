...
const en = {
  ...
  nav: {"home": "Home", "traintrade": "Train Trade", "autochess": "Fool's Gambit", "utopia": "Utopian Theater", "reforge": "Reforge Graces", "score": "Rating Calculator", "league": "League simulator", "changelog": "Changelog"},
  autochess: {
    "title": "Fool's Gambit",
...
const zhCN: Strings = {
  ...
  themeMenu: '主题',
  languageMenu: '语言',
  nav: {"home": "首页", "traintrade": "铁路大亨", "autochess": "愚者棋局", "utopia": "乌托邦剧场", "reforge": "重塑恩赐", "score": "非凡评分计算器", "league": "联赛积分推演", "changelog": "更新日志"},
  autochess: {
    "title": "愚者棋局",
...
const zhTW: Strings = {
  ...
  themeMenu: '主題',
  languageMenu: '語言',
  nav: {"home": "首頁", "traintrade": "鐵路大亨", "autochess": "愚者棋局", "utopia": "烏托邦劇場", "reforge": "重塑恩賜", "score": "非凡評分計算器", "league": "聯賽積分推演", "changelog": "更新日誌"},
  autochess: {
    "title": "愚者棋局",

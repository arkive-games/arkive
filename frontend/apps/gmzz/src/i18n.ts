...
const en = {
  ...
  fellows: {
    ...
    "homeDescription": "The characters you befriend: their skills, stories and the bonds between them.",
    "description": "{{count}} connections, with the five skill lines and five stories the game gives each.",
...
const zhCN: Strings = {
  ...
  fellows: {
    "title": "人脉",
    "relationsTitle": "关系",
    "homeDescription": "可结交的角色：技能、故事，以及彼此之间的关系。",
    "description": "共 {{count}} 位人脉，含各自的 5 条技能与 5 段故事。",
...
const zhTW: Strings = {
  ...
  fellows: {
    "title": "人脈",
    "relationsTitle": "關係",
    "homeDescription": "可結交的角色：技能、故事，以及彼此之間的關係。",
    "description": "共 {{count}} 位人脈，含各自的 5 條技能與 5 段故事。",

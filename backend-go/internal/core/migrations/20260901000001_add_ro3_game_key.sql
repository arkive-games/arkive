-- +goose Up
-- Register the Ragnarok 3 site so forum posts can use the same permanent key as
-- the portal and data pipeline.
-- +goose StatementBegin
CREATE OR REPLACE FUNCTION core.game_keys() RETURNS text[]
    LANGUAGE sql IMMUTABLE PARALLEL SAFE
    AS $$ SELECT ARRAY['aion2', 'gmzz', 'palworld', 'vrising', 'sts2', 'ro3'] $$;
-- +goose StatementEnd
